...
import { Truck, ArrowLeft, Mail, Lock, User, Phone, Building2, FileText, CheckCircle, AlertCircle, Upload, MapPin } from 'lucide-react';
...
export function SupplierRegister() {
  ...
  const validateForm = () => {
    ...
    } else if (!/^[A-Z]{2}\d{8,12}$/.test(formData.vatNumber.replace(/\s/g, ''))) {
      newErrors.vatNumber = 'Invalid VAT format (e.g., GB123456789)';
    }
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      className={`pl-10 h-12 ${errors.companyName ? 'border-red-300' : 'border-slate-200'}`}
                    />
                  </div>
                  {errors.companyName && (
                    <p className="text-sm text-red-600 flex items-center gap-1">
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      className={`pl-10 h-12 ${errors.vatNumber ? 'border-red-300' : 'border-slate-200'}`}
                    />
                  </div>
                  {errors.vatNumber && (
                    <p className="text-sm text-red-600 flex items-center gap-1">
                  ...
                  <p className="text-xs text-slate-500">Format: Country code (2 letters) + 8-12 digits</p>
                </div>
              </div>
              ...
              <div className="space-y-2">
                <Label htmlFor="companyLogo" className="text-slate-700">
                  Company Logo <span className="text-slate-400 text-sm">(Optional)</span>
                </Label>
                <div className="border-2 border-dashed border-slate-300 rounded-xl p-6 text-center hover:border-green-400 transition-colors cursor-pointer">
                  <input
                    id="companyLogo"
                    type="file"
                    accept="image/*"
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Textarea
                    ...
                    className={`pl-10 min-h-24 ${errors.address ? 'border-red-300' : 'border-slate-200'}`}
                  />
                </div>
                {errors.address && (
                  <p className="text-sm text-red-600 flex items-center gap-1">
        ...
        <DialogContent className="border-0 shadow-2xl max-w-md">
          ...
          <div className="text-center space-y-4">
            <p className="text-slate-600">
              Your supplier account has been created successfully. Please login to access your dashboard.
            </p>
            <Button
