...
export function SupplierLayout({ children }: SupplierLayoutProps) {
  ...
  return (
    <div className="flex h-[calc(100vh-57px)]">
      ...
      <div className="w-64 bg-gradient-to-b from-green-900 to-emerald-800 border-r border-green-700 flex-shrink-0 shadow-2xl">
        <div className="p-6">
          <div className="flex items-center gap-3 mb-8">
            ...
            <div>
              <div className="text-white">Supplier Portal</div>
              <div className="text-xs text-green-300">Order Fulfillment</div>
            </div>
          </div>
      ...
      <div className="flex-1 overflow-auto bg-gradient-to-br from-slate-50 via-white to-green-50">
        <div className="p-8">
          {children}
        </div>
      </div>
