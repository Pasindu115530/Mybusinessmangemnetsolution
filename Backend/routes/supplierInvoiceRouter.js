...
supplierInvoiceRouter.get('/my', getInvoicesBySupplierEmail);
supplierInvoiceRouter.get('/all', getInvoicesBySupplierEmail); // Frontend expects /all
supplierInvoiceRouter.get('/stats', getSupplierInvoiceStats); // Frontend expects /stats
